...
export const SPRITES: HeroSprite[] = [
  ...
  { id: "silverpanel",cx: 61.5, cy: 40.0, w: 13, vx: 70,  vy: -25, rot: 10,  t: [0.23, 0.35] },
  { id: "deflector",  cx: 58.5, cy: 32.0, w: 11, vx: 25,  vy: -75, rot: -9,  t: [0.24, 0.36] },
  { id: "handguards", cx: 57.0, cy: 21.0, w: 14, vx: 55,  vy: -55, rot: 10,  t: [0.25, 0.37] },
  { id: "hugger",     cx: 81.0, cy: 54.0, w: 15, vx: 70,  vy: 20,  rot: 10,  t: [0.26, 0.39] },
  // ---- T3: → sin manubrio ----
  { id: "handlebar",  cx: 64.5, cy: 19.0, w: 22, vx: 30,  vy: -80, rot: 10,  t: [0.41, 0.50] },
  // ---- T4: → chasis rodante desarmado (ruedas, tenedor, tanque, tren trasero) ----
  { id: "frontwheel", cx: 84.4, cy: 76.0, w: 30, vx: 75,  vy: 30,  rot: 90,  t: [0.52, 0.68] },
  { id: "rearwheel",  cx: 16.7, cy: 75.5, w: 30, vx: -75, vy: 32,  rot: -90, t: [0.53, 0.69] },
  { id: "fork",       cx: 78.5, cy: 47.0, w: 17, vx: 60,  vy: -35, rot: 8,   t: [0.54, 0.68] },
  { id: "tank",       cx: 52.0, cy: 33.5, w: 25, vx: 20,  vy: -75, rot: -6,  t: [0.55, 0.70] },
  { id: "shock",      cx: 37.5, cy: 60.0, w: 10, vx: -35, vy: 55,  rot: -10, t: [0.56, 0.69] },
  { id: "swingarm",   cx: 23.0, cy: 70.0, w: 24, vx: -65, vy: 35,  rot: -9,  t: [0.56, 0.71] },
  { id: "sidepanels", cx: 44.0, cy: 54.0, w: 19, vx: -45, vy: -55, rot: -8,  t: [0.57, 0.72] },
  // ---- T5: → motor y chasis pelados ----
  { id: "harness",    cx: 49.5, cy: 49.0, w: 19, vx: 25,  vy: -70, rot: 8,   t: [0.74, 0.85] },
  { id: "airbox",     cx: 42.5, cy: 58.5, w: 15, vx: -50, vy: -45, rot: -9,  t: [0.75, 0.86] },
  { id: "headcover",  cx: 59.0, cy: 67.0, w: 17, vx: 60,  vy: 25,  rot: 9,   t: [0.76, 0.87] },
  { id: "ancillaries",cx: 40.5, cy: 69.0, w: 11, vx: -45, vy: 45,  rot: -10, t: [0.76, 0.87] },
];
