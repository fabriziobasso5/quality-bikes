...
export const motorcycles: Motorcycle[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Edición Dark Knight en negro con llantas de radios doradas",
    ],
    specs: { power: "94 hp", transmission: "Sincrónica", gears: "6", cylinders: "2 cilindros", color: "Negro (Dark Knight)", seatHeight: "825 mm", weight: "215 kg" },
    photoCount: 1,
  },
  {
